 ...
 *
 *
 *    Made a copy, all that is changed is
 *
 *     exitCode = BuildTasksRunner.Run(taskList, buildContext);
 *
 *     to
 *
 *     exitCode = BuildTasksRunnerProfiled.Run(taskList, buildContext);
 *
 *
 *             Lots of things internal was needed
 *
 * 
 */
...
namespace UnityEditor.Build.Pipeline
{
    ...
    /// </summary>
    public static class ContentPipelineProfiled
    {
        /// <summary>
